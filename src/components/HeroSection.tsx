      ...
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:grid lg:grid-cols-2 lg:gap-8 flex flex-col-reverse lg:flex-row items-center">
          <div className="mb-12 lg:mb-0 text-center lg:text-left">
            ...
            >
              At our core, we are dedicated to revolutionizing the healthcare ecosystem,
              ensuring accessibility, intuition, and efficiency for all, as we envision a world
              where technology enriches lives effortlessly.
            </motion.p>
            ...
            >
              <button className="rounded-full bg-white text-blue-600 px-8 py-3 text-base font-semibold 
