      ...
      <div className="container mx-auto px-4 py-16 md:py-24 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-700 leading-relaxed">
            At Quantum Leaps, we are dedicated to transforming healthcare through 
            cutting-edge technology. Our mission is to empower healthcare providers 
            with intelligent, intuitive solutions that enhance patient care, 
            streamline operations, and drive medical innovation.
          </p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-16 md:py-24 bg-white">
        <div className="text-center mb-8 md:mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Our diverse and talented team is dedicated to pushing the boundaries of healthcare technology.
          </p>
        </div>
      ...
      <div className="bg-gradient-to-br from-primary-500 to-secondary-500 py-12 md:py-16 text-center">
        <div className="container mx-auto px-4">
          ...
          <p className="text-base md:text-lg text-white max-w-2xl mx-auto mb-6">
            Are you passionate about transforming healthcare through technology? 
            Explore career opportunities with Quantum Leaps.
          </p>
          <a 
            href="/careers" 
