        ...
        <div className="space-y-8">
          ...
          <div className="max-w-4xl mx-auto text-center space-y-6">
            <p className="text-xl text-gray-700 leading-relaxed">
              LabQFusion is a revolutionary Laboratory Information Management System (LIMS) 
              designed to transform laboratory operations across healthcare, research, 
              and diagnostic industries.
            </p>
            
            <p className="text-lg text-gray-600">
              By combining cutting-edge technology with intuitive design, LabQFusion 
              empowers laboratories to achieve unprecedented levels of efficiency, 
        ...
        <div className="space-y-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-all">
              ...
              <h4 className="font-bold text-primary-600 text-xl mb-3">Intelligent Sample Tracking</h4>
              <p className="text-gray-700">
                Real-time tracking of samples from collection to analysis with advanced 
                barcode and RFID technologies, ensuring complete traceability and minimizing errors.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-all">
              ...
              <p className="text-gray-700">
                Powerful data analysis tools with AI-driven insights, predictive modeling, 
                and comprehensive reporting capabilities to accelerate research and diagnostics.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-all">
              ...
              <p className="text-gray-700">
                Enterprise-grade security with end-to-end encryption, comprehensive access 
                controls, and compliance with HIPAA, GDPR, and other international standards.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-all">
              ...
              <p className="text-gray-700">
                Streamline laboratory workflows, reduce manual processes, and 
                significantly improve overall operational productivity.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-all">
              ...
              <p className="text-gray-700">
                Ensure accurate and reliable data management with comprehensive 
                validation, tracking, and audit trail capabilities.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-all">
              ...
              <p className="text-gray-700">
                Flexible and adaptable solution that grows with your laboratory, 
                supporting diverse research and diagnostic needs.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg md:text-xl text-white/80 mb-10 max-w-2xl mx-auto">
              Discover a comprehensive solution that streamlines your laboratory workflows, 
              enhances data integrity, and accelerates scientific breakthroughs.
            </p>
            <button 
