        ...
        <div className="max-w-md w-full space-y-8 text-center">
          <div>
            ...
            <p className="mt-4 text-lg text-gray-600">
              Our servers are temporarily overloaded or under maintenance. 
          ...
          <div className="mt-8 space-y-4">
            ...
            <div className="mt-4 text-center">
              <p className="text-sm text-gray-600">
                If the problem persists, <Link to="/contact" className="text-yellow-600 hover:underline">contact our support team</Link>
              </p>
            </div>
          </div>
        </div>
