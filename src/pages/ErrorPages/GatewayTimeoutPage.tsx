        ...
        <div className="max-w-md w-full space-y-8 text-center">
          <div>
            ...
            <p className="mt-4 text-lg text-gray-600">
              The server didn't respond in time. This could be due to network issues or server overload.
            </p>
          </div>
          <div className="mt-8 space-y-4">
            ...
            <div className="mt-4 text-center">
              <p className="text-sm text-gray-600">
                Check your internet connection or <Link to="/contact" className="text-red-600 hover:underline">contact support</Link>
              </p>
            </div>
          </div>
        </div>
