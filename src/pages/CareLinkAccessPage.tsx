        ...
        <div className="space-y-12">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-700 leading-relaxed mb-8">
              CareLinkAccess is a revolutionary platform designed to bridge communication 
              gaps, streamline healthcare operations, and enhance patient care through 
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-all">
              ...
              <h4 className="font-bold text-emerald-600 text-xl mb-3">Unified Healthcare Ecosystem</h4>
              <p className="text-gray-700">
                Connect multiple healthcare providers, facilities, and departments 
                into a single, cohesive digital platform.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-all">
              ...
              <p className="text-gray-700">
                Instantaneous access to patient information, treatment plans, 
                and medical histories across different healthcare touchpoints.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-all">
              ...
              <p className="text-gray-700">
                Advanced analytics and machine learning to predict trends, 
          ...
          <div className="bg-gray-50 p-8 rounded-lg shadow-md max-w-4xl mx-auto">
            ...
            <p className="text-lg text-gray-700 leading-relaxed text-center">
              To empower healthcare providers with cutting-edge technology that 
              simplifies complex medical workflows, enhances communication, and 
              ultimately improves patient care and organizational efficiency.
            </p>
          </div>
        </div>
      )
        ...
        <div className="space-y-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-all">
              ...
              <h4 className="font-bold text-primary-600 text-xl mb-3">Intelligent Patient Tracking</h4>
              <p className="text-gray-700">
                Real-time tracking of patient journeys, from admission to discharge, 
                with comprehensive digital health records and seamless communication.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-all">
              <div className="bg-secondary-100 rounded-full p-4 inline-block mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-secondary-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M13 5a2 2 0 00-2-2h-2a2 2 0 00-2 2m8 0a2 2 0 00-2-2h-2a2 2 0 00-2 2m0 0h6m-6 0v8a2 2 0 002 2h2a2 2 0 002-2v-8" />
                </svg>
              </div>
              <h4 className="font-bold text-secondary-600 text-xl mb-3">Advanced Analytics</h4>
              <p className="text-gray-700">
                Powerful data analysis tools with predictive modeling and 
                comprehensive reporting to optimize healthcare operations.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-all">
              ...
              <p className="text-gray-700">
                ...
                comprehensive access controls, and HIPAA compliance.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-all">
              ...
              <p className="text-gray-700">
                Streamline healthcare workflows, reduce administrative burden, 
            ...
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-all">
              ...
              <p className="text-gray-700">
                ...
                real-time communication, and personalized healthcare management.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-all">
              ...
              <p className="text-gray-700">
                Flexible and adaptable platform that grows with your healthcare 
                organization, supporting diverse operational needs.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg md:text-xl text-white/80 mb-10 max-w-2xl mx-auto">
              Experience the power of seamless healthcare coordination, 
              intelligent patient tracking, and comprehensive facility management 
              with CareLinkAccess.
            </p>
            <button 
